		...
		<div id="loginWindow"
			...
			<div
				...
				<table>
						...
						<td><input type="text" name="u" style="width: 140px;" class="text"  value="devadmin" onfocus="this.select();"/>
						</td>
						
					</tr>
					<tr>
						<td style="height: 18px"><font color="#FFFFFF" style="font-weight: bolder"><fmt:message key="sso.login.password"/></font></td>
						<td><input type="password" name="p" style="width: 140px;" value="devadmin" class="text" onfocus="this.select();"/>
						</td>
					</tr>
					<tr>
