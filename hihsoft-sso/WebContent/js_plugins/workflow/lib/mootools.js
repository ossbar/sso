...
Number.extend({
	...
	*/
	...
	Arguments:
		precision - integer, number of digits javahiher the decimal point. Can also be negative or zero (default).
...
Element.extend({
	...
	*/
	...
	/*
	Property: injectjavahiher
		Same as <Element.injectBefore>, but inserts the element javahiher.
	*/

	injectjavahiher: function(el){
		return this.inject(el, 'javahiher');
	},
	...
	*/
	...
	Example:
		>var clone = $('myElement').clone().injectjavahiher('myElement');
		>//clones the Element and append the clone javahiher the Element.
	*/
