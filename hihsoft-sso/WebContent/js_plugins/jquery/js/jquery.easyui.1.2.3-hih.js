...
(function($) {
	...
	function _a8(_a9, _aa, _ab) {
		...
		//modified by xjf@20110628
		var _b0 = _b1(_a9, _aa);
		if (_ac.onCheck.call(_a9, _b0, _ab) === false) return;
		//---------------
		var _ad = $(_aa);
		...
		//1074,1075 line in there befor modify
		//add by xjf@20120203
		if ($.isFunction(_ac.onAfterCheck)) {
			_ac.onAfterCheck.call(_a9, _b0, _ab);
		}
		// add end-----------
		function _af(_b2) {
...
//		}
		...
		//add by xjf@20120202
		var checked = $(_c3).tree("getChecked");
		jQuery.each(checked, function(i, n){
			if (_bd(_c3, n.target)) {
				_a8(_c3, n.target, true);
			}
		});	
		//----------add end-----------
	...
	function _104(_105) {
		var _106 = [];
		//---add by xjf@2011-07-04 ---
		var url = ".tree-checkbox1";
		var opt = $.data(_105, "tree").options;
		if (opt.includeHalf !== false) url += ",.tree-checkbox2";
		//---add end---
		// modified by xjf@2011-06-24
		$(_105).find(url).each(function() {
...
(function($) {
	...
	function _1ad(_1ae) {
		...
		var win = $(_1ae).panel($.extend({}, _1af.options, {
					...
					onOpen : function() {
						...
						//add by xjf@20110920:
						//before open the window,reset it's position
	...
	function _1b6(_1b7) {
		...
		_1b8.window.draggable({
			...
			onDrag : function(e) {
				//modified by xjf@20110920
				var left = e.data.left >= 0 ? e.data.left : 0;
				var top = e.data.top >= 0 ? e.data.top : 0;
				_1b8.proxy.css({
							display : "block",
							left : left,
							top : top
			...
			onStopDrag : function(e) {
				...
				var left = e.data.left >= 0 ? e.data.left : 0;
				var top = e.data.top >= 0 ? e.data.top : 0;
				_1b8.options.left = left;
				_1b8.options.top = top;
				$(_1b7).window("move");
				_1b8.proxy.remove();
				_1b8.proxy = null;
			}
...
(function($) {
	...
	var _4ef = {
		...
		refreshRow1 : function(_505, _506) {
			...
			var _508 = opts.rowStyler ? opts.rowStyler.call(_505, _506,
					rows[_506]) : "";
			var tr = _507.find("div.datagrid-body tr[datagrid-row-index="
					+ _506 + "]");
			tr.attr("style", _508 || "");
			tr.children("td").each(function() {
				var td = $(this);
				...
				if (col) {
					var _50a = col.styler ? col.styler(rows[_506][_509],
							rows[_506], _506) : "";
					td.attr("style", _50a || "");
					if (col.hidden) {
						td.hide();
					...
					if (col.formatter) {
						cell.html(col.formatter(rows[_506][_509], rows[_506],
								_506));
					} else {
		...
		updateRow : function(_50d, _50e, row) {
			...
			var tr = _50f.find("div.datagrid-body tr[datagrid-row-index="
					+ _50e + "]");
			for (var _510 in row) {
				...
				if (col) {
					var _511 = col.styler ? col.styler(rows[_50e][_510],
							rows[_50e], _50e) : "";
					td.attr("style", _511 || "");
					if (col.hidden) {
						td.hide();
					...
					if (col.formatter) {
						cell.html(col.formatter(rows[_50e][_510], rows[_50e],
								_50e));
					} else {
			...
			var _511 = opts.rowStyler ? opts.rowStyler.call(_50d, _50e,
					rows[_50e]) : "";
			tr.attr("style", _511 || "");
		...
		insertRow : function(_512, _513, row) {
			...
			var view = $(_512).datagrid("getPanel")
					.children("div.datagrid-view");
			...
			for (var i = data.rows.length - 1; i >= _513; i--) {
				_515.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i + 1);
				var tr = _514.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i + 1);
				if (opts.rownumbers) {
			...
			var tr1 = "<tr datagrid-row-index=\"" + _513 + "\">"
					+ this.renderRow.call(this, _512, _516, true, _513, row)
					+ "</tr>";
			var tr2 = "<tr datagrid-row-index=\"" + _513 + "\">"
					+ this.renderRow.call(this, _512, _517, false, _513, row)
					+ "</tr>";
			if (_513 >= data.rows.length) {
				var _518 = _514.children("div.datagrid-body")
				...
				_514.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + (_513 + 1) + "]")
						.before(tr1);
				_515.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + (_513 + 1) + "]")
						.before(tr2);
		...
		deleteRow : function(_51a, _51b) {
			...
			var view = $(_51a).datagrid("getPanel")
					.children("div.datagrid-view");
			var _51c = view.children("div.datagrid-view1");
			var _51d = view.children("div.datagrid-view2");
			_51c.children("div.datagrid-body").find("tr[datagrid-row-index="
					+ _51b + "]").remove();
			_51d.children("div.datagrid-body").find("tr[datagrid-row-index="
					+ _51b + "]").remove();
			for (var i = _51b + 1; i < data.rows.length; i++) {
				_51d.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i - 1);
				var tr = _51c.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i - 1);
				if (opts.rownumbers) {
		...
		onAfterRender : function(_51f) {
			...
			if (opts.showFooter) {
				var _520 = $(_51f).datagrid("getPanel")
...
(function($) {
	function _543(_544) {
		...
		$(_544).datagrid($.extend({}, opts, {
					view : (opts.showGroup ? _545 : undefined),
					onClickRow : function(_546, row) {
						if (opts.editIndex != _546) {
							...
							$(this).datagrid("getEditors", _546)[0].target
									.focus();
							opts.editIndex = _546;
						}
		...
		$(_544).datagrid("getPanel").find("div.datagrid-body")
	...
	$.fn.propertygrid.parseOptions = function(_54d) {
		var t = $(_54d);
		return $.extend({}, $.fn.datagrid.parseOptions(_54d), {
					showGroup : (t.attr("showGroup")
							? t.attr("showGroup") == "true"
							: undefined)
				});
	};
	var _545 = $.extend({}, $.fn.datagrid.defaults.view, {
		render : function(_54e, _54f, _550) {
			...
			for (var i = 0; i < _554.length; i++) {
				...
				if (!_550) {
					_552.push("<span>");
					_552.push(opts.groupFormatter.call(_54e, _555.fvalue,
							_555.rows));
					_552.push("</span>");
				}
				_552.push("</td>");
				...
				for (var j = 0; j < _555.rows.length; j++) {
					var cls = (_553 % 2 && opts.striped)
							? "class=\"datagrid-row-alt\""
							: "";
					var _556 = opts.rowStyler ? opts.rowStyler.call(_54e, _553,
							_555.rows[j]) : "";
					var _557 = _556 ? "style=\"" + _556 + "\"" : "";
					_552.push("<tr datagrid-row-index=\"" + _553 + "\" " + cls
							+ " " + _557 + ">");
					_552.push(this.renderRow.call(this, _54e, _551, _550, _553,
							_555.rows[j]));
					_552.push("</tr>");
					_553++;
				}
...
(function($) {
	function _566(_567) {
		...
		if (opts.pagination) {
			...
			_56e.pagination({
						...
						pageSize : opts.pageSize,
						pageList : opts.pageList,
						onSelectPage : function(_56f, _570) {
	...
	function _583(_584) {
		...
		_586.find("input[type=checkbox]").unbind().bind("click.treegrid",
				function() {
					if (opts.singleSelect) {
						return false;
					}
	...
	function _589(_58a, _58b) {
		...
		var tr2 = _58d.children("div.datagrid-body").find("tr[node-id=" + _58b
				+ "]");
		var _58e = $(_58a).datagrid("getColumnFields", true).length
				+ (opts.rownumbers ? 1 : 0);
		...
		function _590(tr, _591) {
			$("<tr class=\"treegrid-tr-tree\">"
					+ "<td style=\"border:0px\" colspan=\"" + _591 + "\">"
	...
	function _592(_593, _594, data, _595) {
		...
		if (node) {
			var _598 = _596.children("div.datagrid-body").find("tr[node-id="
					+ _594 + "]");
			var _599 = _597.children("div.datagrid-body").find("tr[node-id="
					+ _594 + "]");
			var cc1 = _598.next("tr.treegrid-tr-tree").children("td")
					.children("div");
			var cc2 = _599.next("tr.treegrid-tr-tree").children("td")
					.children("div");
		} else {
			var cc1 = _596.children("div.datagrid-body")
					.children("div.datagrid-body-inner");
		...
		if (opts.showFooter) {
			opts.view.renderFooter.call(opts.view, _593, _596
							.find("div.datagrid-footer-inner"), true);
			opts.view.renderFooter.call(opts.view, _593, _597
							.find("div.datagrid-footer-inner"), false);
		}
		if (opts.view.onAfterRender) {
	...
	function _5ac(_5ad, _5ae) {
		...
		var body = $(_5ad).datagrid("getPanel")
	...
	function _5ba(_5bb, _5bc) {
		...
		var node = view.find("div.datagrid-body tr[node-id=" + _5bc + "]")
	...
	$.fn.treegrid.methods = {
		...
		reloadFooter : function(jq, _5ec) {
			return jq.each(function() {
						...
						if (opts.showFooter) {
							opts.view.renderFooter.call(opts.view, this, _5ed
											.find("div.datagrid-footer-inner"),
									true);
							opts.view.renderFooter.call(opts.view, this, _5ee
											.find("div.datagrid-footer-inner"),
									false);
							if (opts.view.onAfterRender) {
								opts.view.onAfterRender.call(opts.view, this);
	...
	$.fn.treegrid.parseOptions = function(_5f0) {
		var t = $(_5f0);
		return $.extend({}, $.fn.datagrid.parseOptions(_5f0), {
	...
	var _5f1 = $.extend({}, $.fn.datagrid.defaults.view, {
		render : function(_5f2, _5f3, _5f4) {
			...
			function _5f7(_5f8, _5f9, _5fa) {
				...
				for (var i = 0; i < _5fa.length; i++) {
					...
					var _5fc = opts.rowStyler
							? opts.rowStyler.call(_5f2, row)
							: "";
					var _5fd = _5fc ? "style=\"" + _5fc + "\"" : "";
					_5fb.push("<tr node-id=" + row[opts.idField] + " " + _5fd
							+ ">");
					_5fb = _5fb.concat(view.renderRow.call(view, _5f2, _5f5,
							_5f8, _5f9, row));
					_5fb.push("</tr>");
		...
		refreshRow : function(_60a, id) {
			...
			tr.children("td").each(function() {
				...
				if (col) {
					var _60e = col.styler
							? (col.styler(row[_60d], row) || "")
							: "";
					var _60f = col.hidden ? "style=\"display:none;" + _60e
							+ "\"" : (_60e ? "style=\"" + _60e + "\"" : "");
		...
		onBeforeRender : function(_610, _611, data) {
			...
			if (node) {
				...
				$.data(_610, "treegrid").data = $.data(_610, "treegrid").data
						.concat(data);
			}
			this.treeNodes = data;
	...
	$.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
				...
				view : _5f1,
				editConfig : {
					getTr : function(_618, id) {
						return $(_618).datagrid("getPanel")
...
(function($) {
	function _61c(_61d, _61e) {
		...
		_620.panel("resize", {
					width : (opts.panelWidth ? opts.panelWidth : _61f
							.outerWidth()),
	...
	function init(_625) {
		...
		var _626 = $("<input type=\"text\" class=\"combo-text\">")
				.appendTo(span);
						...
						if (opts.editable) {
							setTimeout(function() {
										...
										if ($.data(_62c, "combo").previousValue != q) {
											...
											_631(_62c);
											opts.keyHandler.query.call(_62c,
													_62f.val());
											_639(_62c, true);
										}
									}, 10);
	...
	function _631(_632) {
		...
		function _635() {
			...
			if (top + _634.outerHeight() > $(window).height()
					+ $(document).scrollTop()) {
	...
	function _64d(_64e, _64f) {
		...
		for (var i = 0; i < _64f.length; i++) {
			var _652 = $("<input type=\"hidden\" class=\"combo-value\">")
					.appendTo(_651);
			if (name) {
				_652.attr("name", name);
			}
	...
	$.fn.combo = function(_65b, _65c) {
		...
		return this.each(function() {
					...
					$("input.combo-text", _65d.combo).attr("readonly",
							!_65d.options.editable);
					_622(this);
	...
	$.fn.combo.parseOptions = function(_662) {
		var t = $(_662);
		return $.extend({}, $.fn.validatebox.parseOptions(_662), {
					width : (parseInt(_662.style.width) || undefined),
...
(function($) {
	...
	function _66e(_67c, _67d, _67e) {
		...
		_67f.find("div.combobox-item-selected")
		...
		for (var i = 0; i < _67d.length; i++) {
			...
			vv.push(v);
			ss.push(s);
			_67f.find("div.combobox-item[value=" + v + "]")
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
						...
						_696.find("div.combobox-item-selected")
								.removeClass("combobox-item-selected");
					});
		},
		loadData : function(jq, data) {
	...
	$.fn.combobox.parseOptions = function(_699) {
		var t = $(_699);
		return $.extend({}, $.fn.combo.parseOptions(_699), {
...
(function($) {
	...
	function _6a3(_6a4) {
		...
		vv = [vv.join(opts.separator)];//add by xjf@20120202
		$(_6a4).combo("setValues", vv)
	...
	$.fn.combotree.parseOptions = function(_6af) {
		return $.extend({}, $.fn.combo.parseOptions(_6af), $.fn.tree
						.parseOptions(_6af));
	};
...
(function($) {
	...
	function _6bb(_6bc, step) {
		...
		if (_6bf.length) {
			_6be = grid.datagrid("getRowIndex",
					_6bf[_6bf.length - 1][opts.idField]);
			_6be += step;
			if (_6be < 0) {
				_6be = 0;
			}
	...
	$.fn.combogrid.parseOptions = function(_6cd) {
		var t = $(_6cd);
		return $.extend({}, $.fn.combo.parseOptions(_6cd), $.fn.datagrid
						.parseOptions(_6cd), {
...
(function($) {
	function _6ce(_6cf) {
		...
		function _6d1() {
			...
			_6d0.calendar = $("<div></div>").appendTo(_6d2)
					.wrap("<div class=\"datebox-calendar-inner\"></div>");
			_6d0.calendar.calendar({
						fit : true,
						border : false,
						onSelect : function(date) {
			...
			$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>")
					.html(opts.currentText).appendTo(_6d4);
			$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>")
					.html(opts.closeText).appendTo(_6d4);
...
(function($) {
	function _6e4(_6e5) {
		...
		$(_6e5).datebox("calendar").calendar({
					onSelect : function(date) {
		...
		if (!_6e6.spinner) {
			var p = $("<div style=\"padding:2px\"><input style=\"width:80px\"></div>")
					.insertAfter(_6e8.children("div.datebox-calendar-inner"));
			_6e6.spinner = p.children("input");
			_6e6.spinner.timespinner({
						showSeconds : true
					}).bind("mousedown", function(e) {
						e.stopPropagation();
					});
			...
			var ok = $("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>")
					.html(opts.okText).appendTo(_6e9);
			ok.hover(function() {
						$(this).addClass("datebox-button-hover");
					}, function() {
						$(this).removeClass("datebox-button-hover");
	...
	function _6ef(_6f1, _6f2, _6f3) {
		...
		function _6f4(date) {
			...
			return tt.join($(_6f1).datetimebox("spinner")
