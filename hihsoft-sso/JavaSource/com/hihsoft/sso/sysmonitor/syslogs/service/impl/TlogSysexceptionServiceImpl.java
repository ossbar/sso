...
public class TlogSysexceptionServiceImpl extends BaseServiceImpl implements
		TlogSysexceptionService {
	 ...
	 */
	public void saveOrUpdateTlogSysexception(TlogSysexception tlogSysexception)
	 ...
	 * @throws DataAccessException
	 */
	public TlogSysexception getTlogSysexceptionById(String id)
			throws ServiceException {
		TlogSysexception tlogSysexception = null;
		String hql = " from TlogSysexception tlogSysexception where tlogSysexception.exception_oid='"
				+ id + "'";
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogSysexceptionByHQL(String hql, Object[] object)
			throws ServiceException {
	...
	public List<?> getTlogSysexceptionPageDataByHQL(String hql,
			Object[] object, int page_size, int pageNo) throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogSysexceptionValueObjectBySQL(String sql,
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogSysexceptionValueObjectByNameQuery(String queryName,
			Object[] object) throws ServiceException {
