...
public class TlogBusinesslogServiceImpl extends BaseServiceImpl implements
		TlogBusinesslogService {
	...
	public TlogBusinesslog getTlogBusinesslogById(String id)
		...
		String hql = " from TlogBusinesslog tlogBusinesslog where tlogBusinesslog.logid='"
				+ id + "'";
