...
public class TlogDbsqlServiceImpl extends BaseServiceImpl implements
		TlogDbsqlService {
	 ...
	 */
	public void saveOrUpdateTlogDbsql(TlogDbsql tlogDbsql)
	...
	public TlogDbsql getTlogDbsqlById(String id) throws ServiceException {
		...
		String hql = " from TlogDbsql tlogDbsql where tlogDbsql.database_oid='"
				+ id + "'";
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogDbsqlByHQL(String hql, Object[] object)
			throws ServiceException {
	...
	public List<?> getTlogDbsqlPageDataByHQL(String hql, Object[] object,
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogDbsqlPageDataByHQL(String hql,
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogDbsqlValueObjectBySQL(String sql, Object[] object)
			throws ServiceException {
	 ...
	 * @throws DataAccessException
	 */
	public List<?> getTlogDbsqlValueObjectByNameQuery(String queryName,
